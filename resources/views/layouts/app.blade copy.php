...
<body class="bg-gray-100">
        ...
        <div id="sidebar" class="w-64 h-screen bg-gradient-to-b from-navy-800 to-navy-950 text-white fixed left-0 top-0 z-30 transform transition-transform duration-300 ease-in-out lg:translate-x-0 shadow-xl no-shift">
            ...
            <nav class="mt-4 px-2 overflow-y-auto h-[calc(100%-10rem)]">
                ...
                <a href="{{ route('dashboard') }}" class="nav-link flex items-center py-3 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 group mb-2 no-shift">
                    <i class="fas fa-tachometer-alt w-6 text-blue-300 group-hover:text-white transition-colors"></i>
                    <span class="ml-3">Tableau de bord</span>
                </a>
                
                <!-- Articles -->
                <div class="mb-2">
                    <div id="articlesHeader" class="nav-link flex items-center justify-between py-3 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 cursor-pointer group no-shift" onclick="toggleSubmenu('articlesSubmenu', 'articlesHeader', 'articlesArrow')">
                        <div class="flex items-center">
                            <i class="fas fa-newspaper w-6 text-blue-300 group-hover:text-white transition-colors"></i>
                            <span class="ml-3">Articles</span>
                        </div>
                        <i id="articlesArrow" class="fas fa-chevron-down text-sm transition-transform duration-300"></i>
                    </div>
                   

                    <!-- Sous-menu Articles avec lien vers Catégories corrigé -->
                    <div id="articlesSubmenu" class="hidden pl-12 mt-1 mb-1 overflow-hidden transition-all duration-300 max-h-0">
                        <a href="{{ route('articles.index') }}" class="flex items-center py-2 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 group my-1 no-shift">
                            <i class="fas fa-list w-5 text-blue-300 group-hover:text-white transition-colors"></i>
                        ...
                        <a href="{{ route('articles.create') }}" class="flex items-center py-2 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 group my-1 no-shift">
                            <i class="fas fa-plus w-5 text-blue-300 group-hover:text-white transition-colors"></i>
                        ...
                        <a href="{{ route('categories.index') }}" class="flex items-center py-2 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 group my-1 no-shift">
                            <i class="fas fa-tags w-5 text-blue-300 group-hover:text-white transition-colors"></i>
                ...
                <div class="mb-2">
                    <div id="productionHeader" class="nav-link flex items-center justify-between py-3 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 cursor-pointer group no-shift" onclick="toggleSubmenu('productionSubmenu', 'productionHeader', 'productionArrow')">
                        <div class="flex items-center">
                            <i class="fas fa-industry w-6 text-blue-300 group-hover:text-white transition-colors"></i>
                            <span class="ml-3">Production</span>
                        </div>
                        <i id="productionArrow" class="fas fa-chevron-down text-sm transition-transform duration-300"></i>
                    </div>
                    <div id="productionSubmenu" class="hidden pl-12 mt-1 mb-1 overflow-hidden transition-all duration-300 max-h-0">
                        ...
                        <a href="{{ route('production.stats') }}" class="flex items-center py-2 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 group my-1 no-shift">
                            <i class="fas fa-chart-bar w-5 text-blue-300 group-hover:text-white transition-colors"></i>
                ...
                <!-- Personnel -->
                <div class="mb-2">
                    <div id="personnelHeader" class="nav-link flex items-center justify-between py-3 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 cursor-pointer group no-shift" onclick="toggleSubmenu('personnelSubmenu', 'personnelHeader', 'personnelArrow')">
                        <div class="flex items-center">
                            <i class="fas fa-users w-6 text-blue-300 group-hover:text-white transition-colors"></i>
                            <span class="ml-3">Personnel</span>
                        </div>
                        <i id="personnelArrow" class="fas fa-chevron-down text-sm transition-transform duration-300"></i>
                    </div>
                    <div id="personnelSubmenu" class="hidden pl-12 mt-1 mb-1 overflow-hidden transition-all duration-300 max-h-0">
                        <a href="" class="flex items-center py-2 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 group my-1 no-shift">
                            <i class="fas fa-user-friends w-5 text-blue-300 group-hover:text-white transition-colors"></i>
                            <span class="ml-2">Employés</span>
                        </a>
                        <a href="" class="flex items-center py-2 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 group my-1 no-shift">
                            <i class="fas fa-building w-5 text-blue-300 group-hover:text-white transition-colors"></i>
                ...
                <a href="" class="nav-link flex items-center py-3 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 group mb-2 no-shift">
                    <i class="fas fa-user-tag w-6 text-blue-300 group-hover:text-white transition-colors"></i>
                ...
                <!-- Mot de passe -->
                <a href="" class="nav-link flex items-center py-3 px-4 rounded-md transition-all duration-200 hover:bg-navy-700 group mb-2 no-shift">
                    <i class="fas fa-key w-6 text-blue-300 group-hover:text-white transition-colors"></i>
            ...
            <div class="absolute bottom-0 w-full border-t border-navy-700 bg-navy-900">
                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" 
                   class="nav-link flex items-center py-4 px-6 transition-all duration-200 hover:bg-navy-800 group no-shift">
                    <i class="fas fa-sign-out-alt w-6 text-blue-300 group-hover:text-white transition-colors"></i>
                ...
                <div class="mb-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="mt-4 md:mt-0 flex space-x-3">
                            ...
                            <button class="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-sm text-sm font-medium text-white hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 no-shift">
    ...
    <script>
        ...
        //     });
        // }
        // Modification de la fonction toggleSubmenu
function toggleSubmenu(submenuId, headerId, arrowId) {
    const submenu = document.getElementById(submenuId);
    const header = document.getElementById(headerId);
    const arrow = document.getElementById(arrowId);
