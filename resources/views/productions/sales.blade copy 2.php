...
<style>
    ...
    /* Meilleure gestion des tableaux sur tous les appareils */
    .overflow-x-auto {
        width: 100%;
        overflow-x: auto;
    ...
    @media screen and (max-width: 639px) {
        ...
        /* Corriger l'affichage des tableaux sur mobile */
    ...
    @media screen and (min-width: 640px) and (max-width: 1023px) {
        ...
        /* Corriger l'affichage des tableaux sur tablettes */
        td, th {
            max-width: 120px;
            font-size: 0.8125rem;
        }
        
        /* Boutons plus compacts sur tablettes */
        .md\:flex-row .space-x-2 > button {
            font-size: 0.875rem;
    ...
    @media (min-width: 1024px) {
        ...
        /* Meilleure gestion des tableaux sur desktop */
        .overflow-x-auto {
            max-width: 100%;
            overflow-x: auto;
        }
        
        /* S'assurer que les modals apparaissent correctement centrés sur grands écrans */
        .sm\:max-w-lg {
            max-width: 32rem;
        }
        
        /* Largeurs de colonnes de tableau appropriées pour desktop */
        td, th {
            max-width: 200px;
        }
        
        /* Colonne d'actions à largeur fixe */
        td:last-child, th:last-child {
            width: 100px;
        }
        
        /* Meilleur espacement de grille pour les formulaires */
        .gap-4.xl\:gap-6 {
            gap: 1.5rem;
        }
    }
    ...
    /* Corriger les problèmes d'espacement dans les tableaux */
    .whitespace-nowrap {
        white-space: nowrap;
    }
            ...
            <form id="addSaleForm" class="space-y-3 sm:space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="stock_display" class="form-input-focus w-full px-3 py-2 sm:px-4 sm:py-2 border border-gray-200 rounded-lg bg-gray-100" readonly>
